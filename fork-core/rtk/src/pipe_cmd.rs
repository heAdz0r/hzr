...
/// fork: RAW_CAP inlined (upstream core/stream.rs)
const RAW_CAP: usize = 10_485_760; // 10 MiB
use crate::truncate::{CAP_LIST, CAP_WARNINGS};
...
pub fn resolve_filter(name: &str) -> Option<fn(&str) -> String> {
    match name {
        ...
        "log" => Some(crate::log_cmd::run_stdin_str),
...
fn git_status_wrapper(input: &str) -> String {
    crate::git::format_status_output(input)
}
...
fn vitest_wrapper(input: &str) -> String {
    ...
    use crate::vitest_cmd::VitestParser;
