...
> **RTK Tool Policy**: Use `rtk` via Bash instead of native Read/Grep/Edit/Write tools.
> - Read files: `rtk read <file>` | Search: `rtk grep` / `rtk rgai` | Edit: `rtk write patch/replace` | Create: `rtk write file`
