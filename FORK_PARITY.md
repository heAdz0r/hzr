# HZR 0.4.0 — fork-core parity ledger

**Audit date:** 2026-08-10
**Status:** HZR 0.4.0 token-economy accounting-integrity delta; full deterministic gate green
...
The 0.4.0 gate verified current engine manifest
...
| ⚪ |Not knowingly included in 0.4.0; exact compatibility path is not affected|
