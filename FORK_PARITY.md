# HZR 0.9.7 — fork-core parity ledger

**Audit date:** 2026-09-03
**Status:** HZR 0.9.7 preserves the imported command surface while improving diagnostic fidelity, effective routing and accounting. Current changes remain subject to the complete deterministic gate.
