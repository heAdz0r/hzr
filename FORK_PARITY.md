# HZR 0.3.8 — fork-core parity ledger

**Audit date:** 2026-08-05
**Status:** HZR 0.3.8 honest-accounting and bounded-output delta; full deterministic gate green
...
The 0.3.8 gate verified current engine manifest
...
| ⚪ |Not knowingly included in 0.3.8; exact compatibility path is not affected|
