# HZR 0.8.2 — fork-core parity ledger

**Audit date:** 2026-09-03
**Status:** HZR 0.8.2 preserves the imported command surface while improving diagnostic fidelity, effective routing and accounting. Current changes remain subject to the complete deterministic gate.
...
### 0.8.2 diagnostic fidelity delta
...
The 0.8.2 router no longer requires optimizer approval for interpreter reads or aggregate
